...
export default function HomeHero() {
  return (
    <section className="bg-backgroundl relative flex h-[500px] w-full flex-col items-center justify-center gap-y-8 overflow-hidden rounded-lg">
      ...
      <div className="flex flex-col justify-center lg:gap-y-4">
        ...
        />
        <p className="max-w-4xl text-center text-lg lg:text-xl">
